...
( while read -r line; do echo -e "node1: $line"; done < node1.log ) &
( while read -r line; do echo -e "node2: $line"; done < node2.log ) &
( while read -r line; do echo -e "node3: $line"; done < node3.log ) &
( while read -r line; do echo -e "node4: $line"; done < node4.log ) &
( while read -r line; do echo -e "contract: $line"; done < contract.log ) &
