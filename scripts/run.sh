...
( while read line; do echo "node1: $line"; done < node1.log ) &
( while read line; do echo "node2: $line"; done < node2.log ) &
( while read line; do echo "node3: $line"; done < node3.log ) &
( while read line; do echo "node4: $line"; done < node4.log ) &
( while read line; do echo "contract: $line"; done < contract.log ) &
